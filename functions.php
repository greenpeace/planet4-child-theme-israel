...
add_filter( 'gform_confirmation_60', 'donation_gform_function', 10, 4 );
...
function add_custom_js_to_head() {
    ?>
        <script type="text/javascript" src="https://payments.payplus.co.il/statics/applePay/scriptV2.js">
        </script>
    <?php
}
